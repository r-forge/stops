...
#' @param data Optinal: Initial data; if provided permutations are performed on the data matrix (see details)
...
#' data(kinshipdelta)
#' fitkin <- rStressMin(kinshipdelta, ndim = 2, r=0.45, type = "interval")
#' set.seed(222)
