...
#' Models & Algorithms:
#' \itemize{
#' \item cops() ... high level interface to fit COPS models as described in Rusch et al. (2021). By setting cordweight to zero they can also be used to fit metric MDS for many different models, see below.
...
#' \item cmdscale(), sammon(): wrappers that return S3 objects to be used with cops
#' \item copstress() ... a function to calculate copstress (Rusch et al., 2021)
