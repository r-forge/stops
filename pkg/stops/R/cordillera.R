...
#'
#' Calculates the OPTICS cordillera as (Rusch et al., 2015). Needs ELKI >0.6.0 - Only tested with the ubuntu binaries.
#'
...
cordillera <- function(confs,q=1,minpts=2,epsilon,rang=NULL,digits=10,path=getwd(),plot=FALSE,ylim,scale=TRUE,...)
    {
        ...
        optres <- optics(confs,minpts=minpts,epsilon=epsilon,path=path,...)
