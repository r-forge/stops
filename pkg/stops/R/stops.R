...
#' @param ... additional arguments to be passed to the outer optimization procedure 
#
#'@return A list with the components
#'         \itemize{
#'         \item stoploss: the weighted loss value
