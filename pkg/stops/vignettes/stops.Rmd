...
resa2<-stops(kinshipdelta,theta=c(3.066,1.001,1.388),structures=c("cclusteredness"),loss="powermds",verbose=3,strucpars=list(list(eps=10,rang=c(0,1.3),minpts=2)),type="additive",strucweight=1,stressweight=0)
resa5<-stops(kinshipdelta,theta=c(3.066,1.001,1.388),structures=c("cclusteredness"),loss="powermds",verbose=3,strucpars=list(list(eps=10,rang=c(0,1.3),minpts=5)),type="additive",strucweight=1,stressweight=0)
```
...
Indeed one can optimize for c-clusteredness alone and then gets a projection with c-clusteredness of 0.62   
```{r,eval=FALSE}
resa2<-stops(kinshipdelta,structures=c("cclusteredness"),loss="powermds",verbose=0,strucpars=list(list(eps=10,rang=c(0,1.3),minpts=2)),type="additive",strucweight=-1,stressweight=0)
```
