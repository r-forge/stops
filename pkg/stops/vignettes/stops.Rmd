...
#approx p stress
set.seed(670)
timeaps <- system.time(restgpaps <- stops(dis,theta=c(1,1),loss="apstress",structures=structures,stressweight=1,strucweight=strucweight,strucpars=strucpars,verbose=4,lower=c(1,1),upper=c(6,6),optimmethod="tgp",model="btgpllm",itmax=10,itmaxps=1e4))
```
