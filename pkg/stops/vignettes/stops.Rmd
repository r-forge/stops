...
We recreate parts of an example of Rusch, Mair and Hornik (2023) here. The data are 500 handwritten pen digits and we subject them to different flexible MDS methods and select hyperparameters with STOPS based on c-clusteredness and c-manifoldness. The data are available in the package.
...
save(restgp,restgpbc,restgplmds,timesam,timebc,timelmds,file="../.devel/pendigresults.rda")
```
```{r,echo=FALSE}
