...
\begin{equation}
  \text{aSTOPS}(X, \theta, w_0, w_k; \Delta) = w_0 \cdot \sigma_{MDS}(X^*(\theta)) + \sum^K_{k=1} w_k I(X^*(\theta))
\end{equation}
 or (multiplicative STOPS)
\begin{equation}
  \text{mSTOPS}(X, \theta, w_0, w_k; \Delta) = \frac{\sigma_{MDS}(X^*(\theta))^{w_0}} {\prod^K_{k=1} I(X^*(\theta))^{w_k}} 
\end{equation}
...
\begin{equation}  
 \arg\min_{\vartheta}\ \text{aSTOPS}(X, \theta, w_0, w_k; \Delta)\quad \text{or} \quad \arg\min_{\vartheta}\ \text{mSTOPS}(X, \theta, w_0, w_k; \Delta)
\end{equation} 
